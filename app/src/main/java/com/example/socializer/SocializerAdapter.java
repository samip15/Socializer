    ...
    public void onBindViewHolder(@NonNull SocializerViewHolder holder, int position) {
        ...
        switch (authorKey)
        {
            case SocializerContract
                    .MANISH_KEY:
                holder.authorIV.setImageResource(R.drawable.images);
                break;

            case SocializerContract
                    .SAMIP_KEY:
                holder.authorIV.setImageResource(R.drawable.profile2);
                break;

            case SocializerContract
                    .RAM_KEY:
                holder.authorIV.setImageResource(R.drawable.profile3);
                break;

            case SocializerContract
                    .HARI_KEY:
                holder.authorIV.setImageResource(R.drawable.profile4);
                break;

            case SocializerContract
                    .SHYAM_KEY:
                holder.authorIV.setImageResource(R.drawable.profile5);
                break;
            default:
                holder.authorIV.setImageResource(R.drawable.profile6);
        }
    }
